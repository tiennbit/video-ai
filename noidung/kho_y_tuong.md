...
### T7. Đạo hàm (tối ưu) — "Vì sao lon nước ngọt có đúng hình dạng đó?" ✅ ĐÃ LÀM (đêm 2026-07-02, slug `lonnuoc`)
...
### T15. Cú xoáy của Messi — "Quả đá phạt vòng qua hàng rào rồi cắm vào góc xa - lực nào bẻ cong nó?" ✅ ĐÃ LÀM (đêm 2026-07-02, slug `magnus`)
...
### L8. Khúc xạ & phản xạ toàn phần — "Ống hút gãy trong nước & cọng cáp quang chở cả Internet" ✅ ĐÃ LÀM (đêm 2026-07-02, slug `capquang`)
...
### L10. Chim đậu dây điện — "Vì sao chim không bị giật mà người thì chết?" ✅ ĐÃ LÀM (đêm 2026-07-02, slug `chimday`)
