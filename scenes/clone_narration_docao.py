"""
Sinh giọng clone cho video "Đo chiều cao toà nhà" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_docao.py
Nguồn: narration_texts_docao.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_docao/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_docao")
