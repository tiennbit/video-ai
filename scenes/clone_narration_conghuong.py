"""
Sinh giọng clone cho video "Cộng hưởng làm sập cầu" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_conghuong.py
Nguồn: narration_texts_conghuong.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_conghuong/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_conghuong")
