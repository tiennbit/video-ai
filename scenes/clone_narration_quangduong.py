"""
Sinh giọng clone cho video "Quãng đường từ đồ thị vận tốc" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_quangduong.py
Nguồn: narration_texts_quangduong.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_quangduong/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_quangduong")
