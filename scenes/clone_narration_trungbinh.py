"""
Sinh giọng clone cho video "Lương trung bình vs trung vị" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_trungbinh.py
Nguồn: narration_texts_trungbinh.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_trungbinh/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_trungbinh")
