"""
Sinh giọng clone cho video "Mật khẩu bị bẻ trong bao lâu" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_matkhau.py
Nguồn: narration_texts_matkhau.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_matkhau/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_matkhau")
