"""
Sinh giọng clone cho video "Xáo bài 52!" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_xaobai.py
Nguồn: narration_texts_xaobai.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_xaobai/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_xaobai")
