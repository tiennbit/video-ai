"""
Sinh giọng clone của user cho video "Quãng phanh ∝ v²" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_phanh.py
Nguồn: narration_texts_phanh.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_phanh/<id>.wav (48kHz). Núm tối ưu giống clone_narration_laikep.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_phanh")
