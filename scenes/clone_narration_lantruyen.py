"""
Sinh giọng clone cho video "Hàm mũ — lan truyền triệu view" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_lantruyen.py
Nguồn: narration_texts_lantruyen.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_lantruyen/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_lantruyen")
