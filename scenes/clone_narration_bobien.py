"""
Sinh giọng clone cho video "Bờ biển dài vô hạn" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_bobien.py
Nguồn: narration_texts_bobien.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_bobien/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_bobien")
