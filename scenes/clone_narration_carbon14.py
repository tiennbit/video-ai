"""
Sinh giọng clone cho video "Định tuổi xác ướp bằng Carbon-14" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_carbon14.py
Nguồn: narration_texts_carbon14.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_carbon14/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_carbon14")
