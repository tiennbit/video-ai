"""
Sinh giọng clone cho video "Xoắn ốc Fibonacci" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_fibonacci.py
Nguồn: narration_texts_fibonacci.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_fibonacci/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_fibonacci")
