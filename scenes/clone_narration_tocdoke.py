"""
Sinh giọng clone cho video "Tốc độ kế chính là đạo hàm" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_tocdoke.py
Nguồn: narration_texts_tocdoke.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_tocdoke/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_tocdoke")
