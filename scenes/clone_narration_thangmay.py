"""
Sinh giọng clone cho video "Thang máy 72kg" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_thangmay.py
Nguồn: narration_texts_thangmay.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_thangmay/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_thangmay")
