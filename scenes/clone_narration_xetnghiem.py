"""
Sinh giọng clone cho video "Xét nghiệm dương tính" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_xetnghiem.py
Nguồn: narration_texts_xetnghiem.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_xetnghiem/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_xetnghiem")
