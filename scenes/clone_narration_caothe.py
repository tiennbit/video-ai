"""
Sinh giọng clone cho video "Vì sao lưới điện 220V?" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_caothe.py
Nguồn: narration_texts_caothe.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_caothe/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_caothe")
