"""
Sinh giọng clone cho video "Cây búa giấu lực 8000 Newton" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_bua.py
Nguồn: narration_texts_bua.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_bua/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_bua")
