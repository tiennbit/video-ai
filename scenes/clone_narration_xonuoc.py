"""
Sinh giọng clone cho video "Xô nước quay không đổ" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_xonuoc.py
Nguồn: narration_texts_xonuoc.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_xonuoc/<id>.wav (48kHz).
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_xonuoc")
