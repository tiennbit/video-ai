"""
Sinh giọng clone cho video "Sét đánh xa bao nhiêu" (VoxCPM2, CPU).
Chạy:  ~/voxcpm-venv/bin/python scenes/clone_narration_setdanh.py
Nguồn: narration_texts_setdanh.py · Mẫu: output/narration/voice-yeu_ref16k.wav
Xuất: output/narration_setdanh/<id>.wav (48kHz). Sau đó nhớ chạy align_narration.py.
"""
import os
import sys
import time
...
OUTDIR = os.path.join(BASE, "output", "narration_setdanh")
